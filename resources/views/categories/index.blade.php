...
function buildHTML(snapshots){
        ...
        alldata.forEach((listval) => {
            ...
            var val=listval;
                ...
                html=html+'<td class="action-btn"><a href="'+route1+'"><i class="fa fa-edit"></i></a><a id="'+val.id+'" name="category-delete" href="javascript:void(0)"><i class="fa fa-trash"></i></a></td>';
...
$(document).on("click","a[name='category-delete']", function (e) {
        var id = this.id;
        alert("This is for demo, We can't allow to delete iteam");
