      ...
      if(code == ''){
        ...
        window.scrollTo(0,0);
          ...
          window.scrollTo(0,0);
              ...
              window.scrollTo(0,0);
       //   console.log('done'+resturant_id+' '+expiresAt);

        }else{

        /* alert("This is for demo, We can't allow to edit"); */
        database.collection('coupons').doc(id).set({'code':code,'description':description,'discount':discount,'expiresAt':expiresAt,'isEnabled':isEnabled,'id':id,'discountType':discountType,'image':photo,'resturant_id':resturant_id}).then(function(result) {
